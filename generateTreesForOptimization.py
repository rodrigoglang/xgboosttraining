...
def generateInputTreesForOptimization(workDirectory, config, muonPhase, zenith, azimuth, offset, environmentVariables, maxEventsForOffruns):
    ...
    command += ' --Diagnostics/WriteEventTree true --Diagnostics/DiagnosticFolder Preselect --Diagnostics/ListOfVariables RunNr,AltEvent,AzEvent,CorrEnergy,MCTrueEnergy,MCTrueAlt,MCTrueAzimuth,ZetaBDT,HillasImageAmplitude'
