...
print(HESSDST)
print('Read OFF data')
print('Looking for: ' + '{}/off_{}_{}/events_*.root'.format(input_dir, phase, config))
f_off = sorted(glob('{}/off_{}_{}/events_*.root'.format(input_dir, phase, config)))
print('f_off: ', f_off)
...
print('Read MC data')
print('Looking for ' + '{}/mc_{}_{}/events_*.root'.format(input_dir, phase, config))
f_mc = sorted(glob('{}/mc_{}_{}/events_*.root'.format(input_dir, phase, config)))
